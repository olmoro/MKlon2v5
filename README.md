...
#### <p align="right">редакция от 9 декабря 2022 года
![](https://github.com/olmoro/Mklon2v5/blob/main/Documents/Img/Mklon2v5.jpg) Базовая версия.
### Это проект для тех, кто наигрался с прошивками и профилями, а дух исследователя подгоняет продолжать поиски новых технических решений вплоть до реализации собственных алгоритмов. В этом случае имеет значение порог вхождения, то есть тот уровень знаний и навыков, необходимых для реализации задуманного. Сможете написать программу для елочной гирлянды на Arduino? имеете навыки пайки печатных плат с элементами SMD? имеете ЗУ типа Кулон, который вам уже скучен урезанным функционалом, но выводить его из строя улучшениями как-то не хочется? - тогда это для вас. Воплотив свою мечту в одночасье заменяете начинку корпуса. По сути предлагается своего рода глубокий "рестайлинг" Кулона, то есть вдохнуть больше жизни в прибор, убрав ненужное и добавив актуальное. Точно знаете что и как хотите реализовать - тогда вперёд.  
...
Подбор коэффициентов - шаманство ещё то, тем более если в наличии только 5-кнопочная клавиатура. Надежда на управление по беспроводной сети.
