...
#### <p align="right">редакция от 12 декабря 2022 года

![](https://github.com/olmoro/MKlon2v5/blob/main/Documents/Img/MKlon2v5a.jpg)
### Это проект для тех, кто наигрался с прошивками и профилями, а дух исследователя подгоняет продолжать поиски новых технических решений вплоть до реализации собственных алгоритмов. Сможете написать программу для елочной гирлянды на Arduino? имеете навыки пайки печатных плат с элементами SMD? имеете ЗУ типа Кулон, который вам уже скучен урезанным функционалом, но выводить его из строя улучшениями как-то не хочется? - тогда это для вас. Воплотив свою мечту в одночасье заменяете начинку корпуса и наслаждаетесь. По сути предлагается своего рода глубокий "рестайлинг" Кулона, то есть вдохнуть больше жизни в прибор, убрав ненужное и добавив актуальное. Точно знаете что и как хотите реализовать, тогда вперёд. В отличие от Кулонов прибор не включается непосредственно в сеть 220 вольт и это должно вас порадовать. А те программисты, которые захотят пополнить свой арсенал найдут ещё один неочевидный вариант реализации конечного автомата (FSM) с использованием виртуальной функции. 
